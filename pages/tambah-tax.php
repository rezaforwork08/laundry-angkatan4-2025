...
if (isset($_POST['simpan'])) {
    ...
    $insert = mysqli_query($config, "INSERT INTO taxs (percent, is_active) 
    VALUES ('$percent', '$is_active')");
...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($config, "UPDATE taxs SET percent='$percent', 
    is_active='$is_active'
    WHERE id = $id");
    if ($update) {
                ...
                <div class="w-50">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="radio" name="is_active"
                            <?php echo $rowEdit ? $rowEdit == 0 ? 'checked' : '' : '' ?>
                            value="0"> Draft
                        <br>
                        <input type="radio" name="is_active"
                            <?php echo $rowEdit ? $rowEdit == 1 ? 'checked' : '' : '' ?>
                            value="1"> Active
                    </div>
