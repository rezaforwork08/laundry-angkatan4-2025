            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        <a href="?page=tambah-tax" class="btn btn-primary">Add Tax</a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="?page=tambah-tax&edit=<?php echo $v['id'] ?>" class="btn btn-success btn-sm">
                                        ...
                                        Edit</a>
                                    <a href="?page=tax&delete=<?php echo $v['id'] ?>" class="btn btn-warning btn-sm" onclick="return confirm('Ingin delete??')">
